  ...
  return `
    ...
    <div class="hop-email-root">
      ...
      <div class="hop-email-inner">
        ...
        <h1 style="margin:14px 0 10px;font-size:32px;line-height:1.08;color:#111827;font-weight:600;font-family:${EMAIL_FONT_STACK};">Your sign-in code</h1>
        ...
        <div style="display:inline-block;border-radius:24px;background:#eef2ef;padding:16px 22px;font-size:32px;letter-spacing:0.28em;font-weight:500;color:#0f3d2e;font-family:${EMAIL_FONT_STACK};">${code}</div>

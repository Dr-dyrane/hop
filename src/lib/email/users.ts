  ...
  return `
    ...
    <div class="hop-email-root">
      ...
      <div class="hop-email-inner">
        ${buildEmailBrandLockup()}
        <div style="font-size:11px;letter-spacing:0.22em;text-transform:uppercase;color:#6b7280;font-weight:500;font-family:${EMAIL_FONT_STACK};">House of Prax</div>
        <h1 style="margin:14px 0 10px;font-size:32px;line-height:1.08;color:#111827;font-weight:600;font-family:${EMAIL_FONT_STACK};">Your workspace is ready</h1>
        ...
        <div style="border-radius:24px;background:#eef2ef;padding:18px;">
          <div style="font-size:11px;letter-spacing:0.18em;text-transform:uppercase;color:#6b7280;font-weight:500;font-family:${EMAIL_FONT_STACK};">How it works</div>
        ...
        <div style="margin-top:20px;">
          <a href="${input.href}" style="display:inline-flex;align-items:center;justify-content:center;min-height:48px;padding:0 22px;border-radius:999px;background:#0f3d2e;color:#ffffff;text-decoration:none;font-size:12px;font-weight:500;letter-spacing:0.14em;text-transform:uppercase;font-family:${EMAIL_FONT_STACK};">
            Open House of Prax
          </a>
        </div>
      </div>

...
function MetricCard({
  ...
  if (size === "mobile") {
    return (
      <article
        style={style}
        className="workspace-surface overflow-hidden rounded-[20px] px-3 py-3 shadow-[0_10px_22px_rgba(15,23,42,0.05)]"
      >
  ...
  return (
    <article className="workspace-surface overflow-hidden rounded-[24px] p-4 shadow-[0_12px_28px_rgba(15,23,42,0.06)] xl:rounded-[28px] xl:p-5 xl:shadow-[0_16px_34px_rgba(15,23,42,0.07)]">

...
function MetricCard({
  ...
  if (size === "mobile") {
    return (
      <article
        style={style}
        className="overflow-hidden squircle bg-[color:var(--surface)]/88 px-3 py-3 shadow-[0_10px_22px_rgba(15,23,42,0.05)] backdrop-blur-md"
      >
  ...
  return (
    <article className="overflow-hidden squircle bg-[color:var(--surface)]/88 p-4 shadow-[0_12px_28px_rgba(15,23,42,0.06)] backdrop-blur-xl  xl:p-5 xl:shadow-[0_16px_34px_rgba(15,23,42,0.07)]">
